...
struct Customer* createCustomer(char* name, Rank rank, int order_amount, int point);
void insertCustomer(struct Customer** head, char* name, Rank rank, int order_amount, int point);
void deleteCustomer(struct Customer** head, char* name);
void updateCustomer(struct Customer* head, char* name, Rank rank, int order_amount, int point);
void printCustomerList(struct Customer* head);
void freeCustomerList(struct Customer* head);
...
void insertCustomer(struct Customer** head, char* name, Rank rank, int order_amount, int point) {
    struct Customer* newCustomer = createCustomer(name, rank, order_amount, point);
